...
export function Sidebar() {
  ...
  const confirmDelete = useCallback(async () => {
    if (!pendingDeleteSessionId || isDeleting) return
    ...
    try {
      ...
      console.error('[Sidebar] Delete session failed:', error)
    } finally {
      setIsDeleting(false)
    }
  }, [closeTab, deleteSession, disconnectSession, pendingDeleteSessionId, isDeleting, addToast])
  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        onClose={() => !isDeleting && setPendingDeleteSessionId(null)}
